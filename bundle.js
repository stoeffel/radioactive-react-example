          ...
          React.createElement("div", {className: "container"}, 
            React.createElement("div", {className: "row"}, 
              React.createElement("div", {className: "col l6 s12"}, 
                React.createElement("a", {className: "grey-text text-lighten-4 right", href: "http://marvel.com"}, "Data provided by Marvel. © 2015 MARVEL")
              ), 
              React.createElement("div", {className: "col l4 offset-l2 s12"}, 
                React.createElement("h5", {className: "white-text"}, "Links"), 
                React.createElement("ul", null, 
                  React.createElement("li", null, React.createElement("a", {className: "grey-text text-lighten-3", href: "https://github.com/stoeffel/radioactive-react-example"}, "source")), 
                  React.createElement("li", null, React.createElement("a", {className: "grey-text text-lighten-3", href: "https://github.com/radioactive/radioactive"}, "radioactive")), 
                  React.createElement("li", null, React.createElement("a", {className: "grey-text text-lighten-3", href: "http://facebook.github.io/react"}, "react")), 
                  React.createElement("li", null, React.createElement("a", {className: "grey-text text-lighten-3", href: "http://materializecss.com"}, "materialize"))
                )
              )
            )
          )
...
var HeroCard = createClass({
  render: function() {
    ...
    if (hero.thumbnail) {
      ...
      img = React.createElement("img", {src:  thumb + ext})
    }
    ...
    return (
      React.createElement("div", {className: "card"}, 
        React.createElement("div", {className: "card-image"}, 
           img, 
          React.createElement("span", {className: "card-title"},  hero.name)
        ), 
        React.createElement("div", {className: "card-content"}, 
          React.createElement("p", null,  hero.description), 
          React.createElement("p", null, React.createElement("a", {href: "http://marvel.com"}, "Data provided by Marvel. © 2015 MARVEL"))
        ), 
        React.createElement("div", {className: "card-action"}, 
          React.createElement("a", {href:  url }, React.createElement("i", {className: "mdi-content-link"}), " marvel/",  hero.name)
        )
      )
    );
  }
...
var HeroListItem = createClass({
  render: function() {
    ...
    if (hero.thumbnail) {
      var thumb = hero.thumbnail.path;
      var ext = '.' + hero.thumbnail.extension;
      img = React.createElement("img", {src:  thumb + ext, alt:  hero.name, className: "circle"});
    }
    var style = {
      "whiteSpace": "nowrap",
      "overflow": "hidden",
    ...
    return (
    React.createElement("a", {style:  { cursor: "pointer"}, className:  "waves-effect collection-item avatar " + this.props.active, onClick: this.props.focusHero.bind(null, this.props.nr)}, 
       img, 
      React.createElement("span", {className: "title"},  hero.name), 
      React.createElement("p", {style: style}, React.createElement("br", null),  hero.description)
    )
    );
  }
});
...
var HeroList = createClass({
  render: function() {
    return (
    React.createElement("div", {className: "z-depth-1 collection"}, 
       this.props.items.map( function(i, key)  {
        var activeCls = key === this.props.activeNr ? 'active': '';
        return React.createElement(HeroListItem, {focusHero: this.props.focusHero, nr: key, active: activeCls, hero: i})
      }.bind(this)) 
    )
    );
  }
...
var Loader = createClass({
  render: function() {
    ...
    return (
      React.createElement("div", {style: style, className: "progress"}, 
        React.createElement("div", {style: style, className: "indeterminate"})
      )
    );
  }
});
        ...
        React.createElement("div", {className: "nav-wrapper"}, 
          ...
          React.createElement("form", {onSubmit: this.onSearch}, 
            React.createElement("div", {className: "input-field"}, 
              React.createElement("input", {id: "search", type: "search", defaultValue: value, onFocus: this.onFocus, onChange: this.onChange, autoComplete: "off", required: true}), 
              React.createElement("label", {htmlFor: "search"}, React.createElement("i", {className: "mdi-action-search"})), 
...
var App = createClass({
  ...
  heros: function() {
    if (this.state.focusedHero && this.state.characters) {
      ...
      if (items.length > 0) {
        list = (
          React.createElement("div", {className: "col s12 m7 l8"}, 
            React.createElement(HeroList, {focusHero: this.focusHero, items:  items, activeNr:  this.state.activeNr})
          )
          );
      };
      return (
        React.createElement("div", {className: "row"}, 
          React.createElement("div", {className: "col s12 m5 l4"}, 
            React.createElement(HeroCard, {hero:  firstResult })
          ), 
           list 
        )
      );
      ...
      return (
          React.createElement("h1", null, "no search result")
      );
    }
  },
